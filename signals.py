...
class Signals:
    ...
    def human_speaking(self, value):
        ...
        if value:
            print("Дебаг: Human Talking Start")
        else:
            print("Дебаг: Human Talking Stop")
    @property
    ...
    def AI_speaking(self, value):
        ...
        if value:
            print("Дебаг: AI Talking Start")
        else:
            print("Дебаг: AI Talking Stop")
    @property
    ...
    def AI_thinking(self, value):
        ...
        if value:
            print("Дебаг: AI Thinking Start")
        else:
            print("Дебаг: AI Thinking Stop")
    @property
